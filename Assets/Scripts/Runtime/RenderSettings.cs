...
public class RenderSettingsData
{
    ...
    public void SaveRenderSettings(string objectName)
    {
        ...
        int newIndex = Directory.GetFiles(directoryPath, $"{objectName}_*_RenderSettings.json")
                ...
                .DefaultIfEmpty(0)
                .Max() + 1;
        string filePath = Path.Combine(directoryPath, $"{objectName}_{newIndex}_RenderSettings.json");
